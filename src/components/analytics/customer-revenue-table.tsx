...
import type { CustomerRevenueRow } from "@/types/analytics";

interface CustomerRevenueTableProps {
  customers: CustomerRevenueRow[];
}

export function CustomerRevenueTable({ customers }: CustomerRevenueTableProps) {
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-base">顧客別売上 Top 10</CardTitle>
      </CardHeader>
